...
namespace Org.OpenAPITools.Model
{
    ...
    /// RandomSearchDto
    /// </summary>
    public partial class RandomSearchDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RandomSearchDto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RandomSearchDto(Option<List<Guid>?> albumIds = default, Option<string?> city = default, Option<string?> country = default, Option<DateTime?> createdAfter = default, Option<DateTime?> createdBefore = default, Option<string?> deviceId = default, Option<bool?> isEncoded = default, Option<bool?> isFavorite = default, Option<bool?> isMotion = default, Option<bool?> isNotInAlbum = default, Option<bool?> isOffline = default, Option<string?> lensModel = default, Option<Guid?> libraryId = default, Option<string?> make = default, Option<string?> model = default, Option<List<Guid>?> personIds = default, Option<decimal?> rating = default, Option<decimal?> size = default, Option<string?> state = default, Option<List<Guid>?> tagIds = default, Option<DateTime?> takenAfter = default, Option<DateTime?> takenBefore = default, Option<DateTime?> trashedAfter = default, Option<DateTime?> trashedBefore = default, Option<AssetTypeEnum?> type = default, Option<DateTime?> updatedAfter = default, Option<DateTime?> updatedBefore = default, Option<AssetVisibility?> visibility = default, Option<bool?> withDeleted = default, Option<bool?> withExif = default, Option<bool?> withPeople = default, Option<bool?> withStacked = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RandomSearchDto {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RandomSearchDto" />
    /// </summary>
    public class RandomSearchDtoJsonConverter : JsonConverter<RandomSearchDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="RandomSearchDto" />
        /// </summary>
        ...
        public override RandomSearchDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (albumIds.IsSet && albumIds.Value == null)
                throw new ArgumentNullException(nameof(albumIds), "Property is not nullable for class RandomSearchDto.");

            if (createdAfter.IsSet && createdAfter.Value == null)
                throw new ArgumentNullException(nameof(createdAfter), "Property is not nullable for class RandomSearchDto.");

            if (createdBefore.IsSet && createdBefore.Value == null)
                throw new ArgumentNullException(nameof(createdBefore), "Property is not nullable for class RandomSearchDto.");

            if (deviceId.IsSet && deviceId.Value == null)
                throw new ArgumentNullException(nameof(deviceId), "Property is not nullable for class RandomSearchDto.");

            if (isEncoded.IsSet && isEncoded.Value == null)
                throw new ArgumentNullException(nameof(isEncoded), "Property is not nullable for class RandomSearchDto.");

            if (isFavorite.IsSet && isFavorite.Value == null)
                throw new ArgumentNullException(nameof(isFavorite), "Property is not nullable for class RandomSearchDto.");

            if (isMotion.IsSet && isMotion.Value == null)
                throw new ArgumentNullException(nameof(isMotion), "Property is not nullable for class RandomSearchDto.");

            if (isNotInAlbum.IsSet && isNotInAlbum.Value == null)
                throw new ArgumentNullException(nameof(isNotInAlbum), "Property is not nullable for class RandomSearchDto.");

            if (isOffline.IsSet && isOffline.Value == null)
                throw new ArgumentNullException(nameof(isOffline), "Property is not nullable for class RandomSearchDto.");

            if (make.IsSet && make.Value == null)
                throw new ArgumentNullException(nameof(make), "Property is not nullable for class RandomSearchDto.");

            if (personIds.IsSet && personIds.Value == null)
                throw new ArgumentNullException(nameof(personIds), "Property is not nullable for class RandomSearchDto.");

            if (rating.IsSet && rating.Value == null)
                throw new ArgumentNullException(nameof(rating), "Property is not nullable for class RandomSearchDto.");

            if (size.IsSet && size.Value == null)
                throw new ArgumentNullException(nameof(size), "Property is not nullable for class RandomSearchDto.");

            if (takenAfter.IsSet && takenAfter.Value == null)
                throw new ArgumentNullException(nameof(takenAfter), "Property is not nullable for class RandomSearchDto.");

            if (takenBefore.IsSet && takenBefore.Value == null)
                throw new ArgumentNullException(nameof(takenBefore), "Property is not nullable for class RandomSearchDto.");

            if (trashedAfter.IsSet && trashedAfter.Value == null)
                throw new ArgumentNullException(nameof(trashedAfter), "Property is not nullable for class RandomSearchDto.");

            if (trashedBefore.IsSet && trashedBefore.Value == null)
                throw new ArgumentNullException(nameof(trashedBefore), "Property is not nullable for class RandomSearchDto.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class RandomSearchDto.");

            if (updatedAfter.IsSet && updatedAfter.Value == null)
                throw new ArgumentNullException(nameof(updatedAfter), "Property is not nullable for class RandomSearchDto.");

            if (updatedBefore.IsSet && updatedBefore.Value == null)
                throw new ArgumentNullException(nameof(updatedBefore), "Property is not nullable for class RandomSearchDto.");

            if (visibility.IsSet && visibility.Value == null)
                throw new ArgumentNullException(nameof(visibility), "Property is not nullable for class RandomSearchDto.");

            if (withDeleted.IsSet && withDeleted.Value == null)
                throw new ArgumentNullException(nameof(withDeleted), "Property is not nullable for class RandomSearchDto.");

            if (withExif.IsSet && withExif.Value == null)
                throw new ArgumentNullException(nameof(withExif), "Property is not nullable for class RandomSearchDto.");

            if (withPeople.IsSet && withPeople.Value == null)
                throw new ArgumentNullException(nameof(withPeople), "Property is not nullable for class RandomSearchDto.");

            if (withStacked.IsSet && withStacked.Value == null)
                throw new ArgumentNullException(nameof(withStacked), "Property is not nullable for class RandomSearchDto.");

            return new RandomSearchDto(albumIds, city, country, createdAfter, createdBefore, deviceId, isEncoded, isFavorite, isMotion, isNotInAlbum, isOffline, lensModel, libraryId, make, model, personIds, rating, size, state, tagIds, takenAfter, takenBefore, trashedAfter, trashedBefore, type, updatedAfter, updatedBefore, visibility, withDeleted, withExif, withPeople, withStacked);
        }

        /// <summary>
        /// Serializes a <see cref="RandomSearchDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="randomSearchDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RandomSearchDto randomSearchDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, randomSearchDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RandomSearchDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="randomSearchDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RandomSearchDto randomSearchDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (randomSearchDto.AlbumIdsOption.IsSet && randomSearchDto.AlbumIds == null)
                throw new ArgumentNullException(nameof(randomSearchDto.AlbumIds), "Property is required for class RandomSearchDto.");

            if (randomSearchDto.DeviceIdOption.IsSet && randomSearchDto.DeviceId == null)
                throw new ArgumentNullException(nameof(randomSearchDto.DeviceId), "Property is required for class RandomSearchDto.");

            if (randomSearchDto.MakeOption.IsSet && randomSearchDto.Make == null)
                throw new ArgumentNullException(nameof(randomSearchDto.Make), "Property is required for class RandomSearchDto.");

            if (randomSearchDto.PersonIdsOption.IsSet && randomSearchDto.PersonIds == null)
                throw new ArgumentNullException(nameof(randomSearchDto.PersonIds), "Property is required for class RandomSearchDto.");

            if (randomSearchDto.AlbumIdsOption.IsSet)
            {
                writer.WritePropertyName("albumIds");
                JsonSerializer.Serialize(writer, randomSearchDto.AlbumIds, jsonSerializerOptions);
            }
            if (randomSearchDto.CityOption.IsSet)
                if (randomSearchDto.CityOption.Value != null)
                    writer.WriteString("city", randomSearchDto.City);
                else
                    writer.WriteNull("city");

            if (randomSearchDto.CountryOption.IsSet)
                if (randomSearchDto.CountryOption.Value != null)
                    writer.WriteString("country", randomSearchDto.Country);
                else
                    writer.WriteNull("country");

            if (randomSearchDto.CreatedAfterOption.IsSet)
                writer.WriteString("createdAfter", randomSearchDto.CreatedAfterOption.Value!.Value.ToString(CreatedAfterFormat));

            if (randomSearchDto.CreatedBeforeOption.IsSet)
                writer.WriteString("createdBefore", randomSearchDto.CreatedBeforeOption.Value!.Value.ToString(CreatedBeforeFormat));

            if (randomSearchDto.DeviceIdOption.IsSet)
                writer.WriteString("deviceId", randomSearchDto.DeviceId);

            if (randomSearchDto.IsEncodedOption.IsSet)
                writer.WriteBoolean("isEncoded", randomSearchDto.IsEncodedOption.Value!.Value);

            if (randomSearchDto.IsFavoriteOption.IsSet)
                writer.WriteBoolean("isFavorite", randomSearchDto.IsFavoriteOption.Value!.Value);

            if (randomSearchDto.IsMotionOption.IsSet)
                writer.WriteBoolean("isMotion", randomSearchDto.IsMotionOption.Value!.Value);

            if (randomSearchDto.IsNotInAlbumOption.IsSet)
                writer.WriteBoolean("isNotInAlbum", randomSearchDto.IsNotInAlbumOption.Value!.Value);

            if (randomSearchDto.IsOfflineOption.IsSet)
                writer.WriteBoolean("isOffline", randomSearchDto.IsOfflineOption.Value!.Value);

            if (randomSearchDto.LensModelOption.IsSet)
                if (randomSearchDto.LensModelOption.Value != null)
                    writer.WriteString("lensModel", randomSearchDto.LensModel);
                else
                    writer.WriteNull("lensModel");

            if (randomSearchDto.LibraryIdOption.IsSet)
                if (randomSearchDto.LibraryIdOption.Value != null)
                    writer.WriteString("libraryId", randomSearchDto.LibraryIdOption.Value!.Value);
                else
                    writer.WriteNull("libraryId");

            if (randomSearchDto.MakeOption.IsSet)
                writer.WriteString("make", randomSearchDto.Make);

            if (randomSearchDto.ModelOption.IsSet)
                if (randomSearchDto.ModelOption.Value != null)
                    writer.WriteString("model", randomSearchDto.Model);
                else
                    writer.WriteNull("model");

            if (randomSearchDto.PersonIdsOption.IsSet)
            {
                writer.WritePropertyName("personIds");
                JsonSerializer.Serialize(writer, randomSearchDto.PersonIds, jsonSerializerOptions);
            }
            if (randomSearchDto.RatingOption.IsSet)
                writer.WriteNumber("rating", randomSearchDto.RatingOption.Value!.Value);

            if (randomSearchDto.SizeOption.IsSet)
                writer.WriteNumber("size", randomSearchDto.SizeOption.Value!.Value);

            if (randomSearchDto.StateOption.IsSet)
                if (randomSearchDto.StateOption.Value != null)
                    writer.WriteString("state", randomSearchDto.State);
                else
                    writer.WriteNull("state");

            if (randomSearchDto.TagIdsOption.IsSet)
                if (randomSearchDto.TagIdsOption.Value != null)
                {
                    writer.WritePropertyName("tagIds");
                    JsonSerializer.Serialize(writer, randomSearchDto.TagIds, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("tagIds");
            if (randomSearchDto.TakenAfterOption.IsSet)
                writer.WriteString("takenAfter", randomSearchDto.TakenAfterOption.Value!.Value.ToString(TakenAfterFormat));

            if (randomSearchDto.TakenBeforeOption.IsSet)
                writer.WriteString("takenBefore", randomSearchDto.TakenBeforeOption.Value!.Value.ToString(TakenBeforeFormat));

            if (randomSearchDto.TrashedAfterOption.IsSet)
                writer.WriteString("trashedAfter", randomSearchDto.TrashedAfterOption.Value!.Value.ToString(TrashedAfterFormat));

            if (randomSearchDto.TrashedBeforeOption.IsSet)
                writer.WriteString("trashedBefore", randomSearchDto.TrashedBeforeOption.Value!.Value.ToString(TrashedBeforeFormat));

            if (randomSearchDto.TypeOption.IsSet)
            {
                var typeRawValue = AssetTypeEnumValueConverter.ToJsonValue(randomSearchDto.Type!.Value);
                writer.WriteString("type", typeRawValue);
            }
            if (randomSearchDto.UpdatedAfterOption.IsSet)
                writer.WriteString("updatedAfter", randomSearchDto.UpdatedAfterOption.Value!.Value.ToString(UpdatedAfterFormat));

            if (randomSearchDto.UpdatedBeforeOption.IsSet)
                writer.WriteString("updatedBefore", randomSearchDto.UpdatedBeforeOption.Value!.Value.ToString(UpdatedBeforeFormat));

            if (randomSearchDto.VisibilityOption.IsSet)
            {
                var visibilityRawValue = AssetVisibilityValueConverter.ToJsonValue(randomSearchDto.Visibility!.Value);
                writer.WriteString("visibility", visibilityRawValue);
            }
            if (randomSearchDto.WithDeletedOption.IsSet)
                writer.WriteBoolean("withDeleted", randomSearchDto.WithDeletedOption.Value!.Value);

            if (randomSearchDto.WithExifOption.IsSet)
                writer.WriteBoolean("withExif", randomSearchDto.WithExifOption.Value!.Value);

            if (randomSearchDto.WithPeopleOption.IsSet)
                writer.WriteBoolean("withPeople", randomSearchDto.WithPeopleOption.Value!.Value);

            if (randomSearchDto.WithStackedOption.IsSet)
                writer.WriteBoolean("withStacked", randomSearchDto.WithStackedOption.Value!.Value);
        }
    }
}
